...
function test_scripts() {
	...
	if(is_front_page()) {
		wp_enqueue_script( 'test-chart', 'https://cdn.jsdelivr.net/npm/chart.js@2.8.0/dist/Chart.js' );
		wp_enqueue_script( 'test-utils', get_template_directory_uri() . '/js/utils.js', array(), '20151215', true );
		wp_enqueue_script( 'test-chartpage', get_template_directory_uri() . '/js/chartpage.js', array(), '20151215', true );
	}
}
